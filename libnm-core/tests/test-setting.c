...
test_bridge_vlans (void)
{
	...
	g_assert_cmpint (nm_bridge_vlan_get_vid_range (v1, &vid, &vid_end), ==, TRUE);
	g_assert_cmpuint (vid, ==, 2);
	...
	g_assert_cmpint (nm_bridge_vlan_get_vid_range (v1, &vid, &vid_end), ==, FALSE);
	g_assert_cmpuint (vid, ==, 10);
	g_assert_cmpuint (vid_end, ==, 0);
